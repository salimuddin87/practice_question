...
length of the jumps that can be made forward from that element. This means if arr[i] = x, then we
can jump any distance y such that y ≤ x.
...
takes the array arr and it's size n as input parameters and returns the minimum number of jumps.
